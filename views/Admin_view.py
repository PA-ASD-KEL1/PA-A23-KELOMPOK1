    ...
    def sub_menu(self, table):
        while True:
            try:
                ...
                print("\033[1;36m├───────────────────────┤\033[0m")
                print("\033[92m│ 1. Create {}      │\033[0m".format(table))
                print("\033[92m│ 2. Read {}       │\033[0m".format(table))
                print("\033[92m│ 3. Update {}      │\033[0m".format(table))
                print("\033[92m│ 4. Delete {}      │\033[0m".format(table))
